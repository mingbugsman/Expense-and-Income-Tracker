...
namespace Expense_Tracker_App.Repository
{
    public interface IRecurringTransactionRepository
    {
        ...
        Task<List<RecurringTransaction>> SearchRecurringTransactionsAsync(string userId, string? searchTerm, int? categoryId, string? frequency, DateTime? startDate, DateTime? endDate, decimal? minAmount, decimal? maxAmount);
    }
}
